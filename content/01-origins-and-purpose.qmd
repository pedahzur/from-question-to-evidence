...
This manuscript now tests the method through two complete modules. The first moves from a question to an evidence map and collection plan. The second turns the scholarly source family into a literature corpus, synthesis, coverage audit, and stopping rule. Both use the same page pattern, preserve consequential decisions, and assign AI bounded roles.
