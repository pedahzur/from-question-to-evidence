...
When the corpus grows past what close reading alone can order, computational grounded theory offers a documented division of labor: unsupervised pattern detection proposes structure, guided close reading interprets it, and a separate computational step confirms or rejects the interpretation.^[See @nelson2020cgt; for a full-scale application, @nelson2021cycles.] The framework has critics. They argue that unsupervised models do not return natural units of meaning and that interpretation deserves more weight than the original design gave it; that debate is itself useful reading before adopting the workflow.^[See @carlsen2022revisited.] Recent applications show the cycle operating at scale, from half a million forum comments coded through topic models, close reading, and embedding-based confirmation, to human-in-the-loop extensions that add explicit theoretical sampling.^[See @adekunle2025covid and @alqazlan2025hitl.] The three steps map onto the voices of this stage: detection proposes, the reviewer reads, and confirmation tests what the reviewer concluded.
