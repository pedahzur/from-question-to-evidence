...
The final movement therefore joins three activities.[@page2021prisma; @rethlefsen2021prismas] Synthesize what the corpus can support. Audit how the corpus was assembled and represented. State why searching and reading can stop for the present purpose.
...
Screening technology has changed the arithmetic of stopping without changing its logic. Active-learning systems rank unscreened records by predicted relevance and re-rank as the researcher labels them; simulation studies across disciplines report that most relevant records surface after a fraction of the corpus has been read.^[See @vandeschoot2021asreview and @ferdinands2023discovery; for the state of the simulation literature, @teijema2025scoping.] The decisions remain human. The researcher labels every included record, and a staged stopping heuristic structures the judgment about when the risk of a missed record no longer justifies further screening; it does not automate that judgment.^[See @boetje2024safe; for comparative evidence on stopping criteria in a social-science field, @campos2024screening; for a discipline-facing tutorial, @futterer2026fasttrack.] Record the classifier, the seed set, the stopping criterion, and the point at which screening stopped, exactly as with any other route.
