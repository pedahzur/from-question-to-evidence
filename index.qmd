...
description: "A living field guide for historically grounded social research with big data and large language models"
author:
  - "Ami Pedahzur"
  - "Jonathan Grossman"
date: "2026-07-12"
...
We have revived the project around one claim: historically grounded social research needs a visible chain from question to source, from source to corpus, and from corpus to claim before the collection becomes too large to reason about. An evidence map begins that chain by linking a bounded question to concepts, source families, search decisions, evaluated records, known gaps, and a stopping rule. It does not promise omniscience. It makes the limits of collection visible.
